...
const forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    await sendEmail({
      email: user.email,
      subject: 'Your password reset token (10 minutes valid)',
      message,
    });
...
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1Y2E4YTkyNDRjZTc0NmJmNDQ4NDA1OSIsImlhdCI6MTcwNzg1MzYyMCwiZXhwIjoxNzE1NjI5NjIwfQ.AsYJXzBiGTL4HNybdBU-3wKCyY9z9KtU8GuEYKw6pB4
