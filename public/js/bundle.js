    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 10:
          ...
          (0, _alerts.showAlert)('error', 'Error loggin out! Try it again...');
...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFyY29zZGFuaWVsMjAwMiIsImEiOiJjbHN3MjJucHMybmp1Mmtvdzl5eDV3bnFsIn0.D3p_Bs5yuqzYhM0uTiq1bA';
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee(formData, type) {
    var url, res, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 8:
          ...
          return _context.abrupt("return", (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " user successfully")));
...
if (userPasswordForm) {
  ...
  function () {
    ...
    _regeneratorRuntime().mark(function _callee(e) {
      var btnSubmit, formPassword, formNewPassword, formNewPasswordConfirm, password, newPassword, newPasswordConfirm;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            btnSubmit = document.querySelector('.btn--save-password');
            formPassword = document.getElementById('password-current');
            formNewPassword = document.getElementById('password');
            formNewPasswordConfirm = document.getElementById('password-confirm');
            btnSubmit.textContent = 'Updating...';
            password = formPassword.value;
            newPassword = formNewPassword.value;
            newPasswordConfirm = formNewPasswordConfirm.value;
            _context.next = 11;
